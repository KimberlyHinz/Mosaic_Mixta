...
**Methods:** Ten complete or partial genomes – two *Mixta* species, six species from other *Erwinicieae* genera, and two outgroups – were retrieved from NCBI and annotated. Homologous genes were extracted. The ClustalW algorithm was used for the alignment and model testing and distance matrices were computed through MEGA-CC.
...
## Background
### Mixta species
The bacterial family Erwiniaceae includes diverse Gram-negative [Winslow et  al. 1917; Prakash et al. 2015 organisms including, at the time of this writing, the genera Mixta, Pantoea, Erwinia, Tatumella, Buchnera, Wigglesworthia, Phaseolibacter, Kalamiella (LPSN, http://www.bacterio.net/). For example, the genus Erwinia contains plant pathogens (e.g. E. amylovora) [Hauben & Swings, 2005; López et  al. 2011; Matsuura et  al. 2012], epiphytes (e.g. E. tasmaniensis) [Geider et  al. 2006; Mergaert et  al. 1999], species that may contribute to plant disease [Buonaurio et  al. 2015], and insect-associated bacteria [Campillo et  al. 2015; Harada et  al. 1997; Skrodenyte-Arbaciauskiene et  al. 2012]. Similarly, Pantoea, a genus reported by Gavini et al. [1989], includes species that inhabit a variety of environments [Gavini et  al. 1989; Popp et  al. 2010; Liu et  al. 2013] and include known human and plant pathogens [Prakash et al. 2015; De Baere et al. 2004; Fullerton et al. 2007; Kratz et al. 2003; Lim et al. 2006; Schmid et al. 2003; Van Rostenberghe et al. 2006] as well as species associated with plant growth [Smits et al. 2011; Kim et al. 2012], with insects [Palmer et al. 2016], and with fungi [Ma et al. 2016, Rong et al. 2016]. Mixta, originally Pantoea, is a novel genus first suggested by Palmer et al. [Palmer et al. 2017] and then later proposed by the same researchers in 2018 [Palmer et al. 2018]. Two species, M. calida and M. gaviniae (the Pantoea), were originally found in infant formula and its production environment [Popp et al. 2010] and Fritz et al. [Fritz et al. 2014] demonstrated that some strains of M. calida were linked with post-surgical meningitis in humans. Currently, there are only five Mixta species validly published (LPSN, http://www.bacterio.net/).
...
## Purpose
The purpose of my honours thesis is to determine the cause behind the contentious phylogenetic results for two of the *Mixta* species and identify gene transfer events.

## Brief study description
Ten complete or partial genomes – two each for *Mixta*, *Pantoea*, *Erwinia*, *Tatumella*, and outgroup – were retrieved from the National Centre for Biotechnology Information (NCBI; http://www.ncbi.nlm.nig.gov/). The genomes were annotated with Prokka v1.14.1 [@Seemann2014] and homologous genes were extracted using GET_HOMOLOGUES software package [@Contreras-Moreira2013]. A filter pipeline was written in `R` [@RCore2019] to remove any files containing truncated, missing, or paralogous genes. The genes were then aligned using the ClustalW algorithm with the `msaClustalW()` [@Bodenhofer2015] function in `R` (package: `msa`). Model testing and distance matrices were computed using MEGA-CC [@Kumar2012].
